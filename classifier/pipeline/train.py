...
from classifier.utils.data import plot_history, prepare_dataset
...
def train_and_log_model(file_path):
    ...
    config_path = os.path.abspath(
        os.path.join(base_dir, "..", "config", "mlflow_config.yaml")
    )
    ...
    with mlflow.start_run():
        ...
        model = build_model(
            X_train.shape[1:], params["l2_reg"], params["learning_rate"]
        )
