...
|----------|-------------|-------------|
| **[🚀 Test & Run Guide](docs/TEST_RUN.md)** | Get up and running the app | [Install](docs/TEST_RUN.md#installation) • [Run](docs/TEST_RUN.md#how-to-run-with-docker-compose) • [Test](docs/TEST_RUN.md#how-to-test) |
